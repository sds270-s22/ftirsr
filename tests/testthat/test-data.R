...
test_that("Checking read_ftirs_file", {
  ...
  expect_error(suppressWarnings(read_ftirs_file("test_samples/FISK-10.0.csv", "~/ftirsr/tests/testthat/test_samples/FISK-270.0.csv")))
...
test_that("Checking read_ftirs", {
  expect_equal(as.ftirs(as_tibble(suppressWarnings(read_ftirs("~/ftirsr/tests/testthat/test_samples")))), head(greenland %>% select(-2), 5643))
...
test_that("Checking read_wet_chem", {
  expect_equal(read_wet_chem("~/ftirsr/tests/testthat/wet-chem-data.csv", greenland %>% select(-2)), greenland)
  expect_equal(names(read_wet_chem("~/ftirsr/tests/testthat/wet-chem-data.csv", greenland %>% select(-2))), c("sample_id", "bsi", "wavenumber", "absorbance"))
  expect_s3_class(read_wet_chem("~/ftirsr/tests/testthat/wet-chem-data.csv", greenland %>% select(-2)), "ftirs")
  expect_type(read_wet_chem("~/ftirsr/tests/testthat/wet-chem-data.csv", greenland %>% select(-2))$bsi, "double")
})
...
test_that("Checking as_ftirs", {
  ...
  expect_s3_class(as_ftirs(read_csv("~/ftirsr/tests/testthat/test_samples/FISK-10.0.csv")), "ftirs")
})
...
=======
  ...
  multiple_sample <- suppressWarnings(read_ftirs("~/ftirsr/tests/testthat/test_samples", interpolate = FALSE))
>>>>>>> db26ef2ca6653b0870fbc8453a16377bb30315ad
