...
The goal of `ftirsr` is to help easily create a Partial Least Squares Regression model to estimate composition of natural compounds such as Biogenic Silica and Total Organic Carbon in lake sediment core samples. This package aids a user in eliminating
