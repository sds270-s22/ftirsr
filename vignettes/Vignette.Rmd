...
In order to install the `ftirs` package, you will need the following R packages:
...
- `is_ftirs`: A method that checks if an object is an `ftirs` object. 

- `as_ftirs`: A method that will attach the `ftirs` attribute to an object.
